    ...
    <section className="bg-white">
      <div className="grid max-w-7xl mx-auto p-4 md:py-3 lg:p-6 grid-flow-row  ">
        <div className="mx-auto flex flex-col justify-center  items-center">
          <div className="hidden md:grid grid-cols-4 p-4 ">
            <div className=" col-span-4 p-3">
              <div className="grid grid-cols-12">
                ...
                <div className=" col-span-7 self-center border-b p-3 border-blue-500">
                  <img src={trusty} alt="" />
                </div>
        ...
        <div className="flex flex-col gap-5 md:gap-8 bg-gradient-to-bl from-blue-400 to-sky-900 text-justify py-6 px-8 md:py-12 md:px-16 mt-2">
          <div className="flex flex-col justify-center items-center gap-4 mx-auto">
            ...
            <p className=" leading-7 text-white md:font-semibold">

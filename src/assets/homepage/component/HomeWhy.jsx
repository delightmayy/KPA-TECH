    ...
    >
      <div className="flex flex-col max-w-7xl mx-auto  text-center md:text-start gap-4 md:gap-10 md:px-8 lg:px-32 relative ">
        <div className="flex flex-col mx-auto text-center p-4 md:px-8">
          <h3 className="text-lg md:text-2xl font-bold capitalize pt-6 pb-4">
            {" "}
            why choose us
          </h3>
        ...
        <div className="grid grid-flow-row md:grid-cols-2 mx-6 gap-4  ">
          {items.map((x) => {
            return (
              <motion.div
                variants={{ scale: { scale: 0.9 }, initial: { scale: 0 } }}
                whileInView="scale"
                initial="initial"
                key={x.id}
                className="p-4  py-6 lg:px-6 rounded-md shadow-slate-400 shadow-sm bg-white flex flex-col gap-4 "
              >
                <motion.img
                  variants={{
                ...
                <p className="text-center text-sm md:text-base md:mb-2">
                  {x.text}
                </p>
                ''
              </motion.div>
        ...
        <div className="grid grid-flow-row md:grid-cols-3 px-4 md:mt-8 gap-4">
          ...
          <div className="p-2 ">
            ...
            <img
              src={icon6}
              alt=""
              className=" hidden md:block md:absolute -left-2 lg:-left-6 bottom-40"
              width={50}
            />
          </div>
        </div>
        <div className="flex flex-col md:flex-row justify-between p-4 px-6 ">
          <div className="p-1 md:w-2/4">
            <h3 className="text-center font-bold md:text-start text-lg pb-2">

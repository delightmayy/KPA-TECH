...
const PortInsta = () => {
  return (
    <section className="bg-[url('/src/assets/portfoliopage/portimg/instabg.png')] bg-cover overflow-x-hidden">
      <div className="pt-8  mx-auto max-w-7xl sm:-mt-3  flex flex-col gap-4">
        <div className="p-4 md:px-8 md:pt-10 lg:p-16 flex flex-col items-start sm:grid sm:grid-cols-2 text-white mt-8 ">
          <motion.div
            ...
            initial="initial"
          whileInView="animate"
           transition ={ { duration:0.8, type: spring , delay:0.2}} className="flex flex-col justify-center sm:items-start text-center sm:text-start items-center mx-auto lg:gap-6">
            <div className="text flex flex-col justify-center p-4 md:px-8 gap-4 lg:gap-8">
              ...
              <h4 className=" font-semibold text-center sm:text-start ">
                A powerful platform designed to help you create campaigns,
                generate leads, and automatically engage with your prospects.
              </h4>
              <p className=" text-sm text-center sm:text-start">
                Through iterative development and continuous refinement, KPA
                ensured that the platform offers intuitive functionality,
                seamless user experience, and effective performance.
              </p>
          ...
          <motion.div
            ...
            className="p-2 mx-auto mt-8 sm:mx-0 flex justify-center pb-12 items-center "
          >

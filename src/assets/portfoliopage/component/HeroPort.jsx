    ...
    <section className="bg-white">
      ...
      <section className="bg-[url('/src/assets/portfoliopage/portimg/portbg1.png')] bg-cover ">
        <div className="max-w-7xl mx-auto flex flex-col py-16 sm:py-24 lg:py-32 px-4  sm:px-6 lg:px-8 ">
          <div className=" mx-auto text-black flex flex-col gap-4 md:gap-8 md:p-4 text-center md:mb-4">
            ...
            <div className=" sm:bg-[#0C4B77] p-2  rounded-lg">
              ...
              {
                    tabIteem.map((tab, id)=>(
                <li  key={id} className={`   ${id+1===handleShow && "text-white bg-[#1066a3]"} first:sm:rounded-s-lg last:sm:rounded-r-lg  p-2 ps-4  w-full`} >
